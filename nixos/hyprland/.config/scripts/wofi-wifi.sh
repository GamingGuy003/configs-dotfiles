...
FIELDS=SSID,SECURITY,BARS,IN-USE
...
CHENTRY=$(echo -e "$TOGGLE\nManual\n$LIST" | uniq -u | wofi -i -d --prompt "Wi-Fi SSID: " --lines "$LINENUM" --width 350)
#echo "$CHENTRY"
...
if [ "$CHENTRY" = "Manual" ] ; then
	...
	MSSID=$(echo "Enter the SSID of the network (SSID,password)" | wofi -d "Manual Entry: " --lines 1 --prompt "SSID,Password")
